    ...
    <main className="about">
      ...
      <div className="about-content">
        ...
        <p className="text-content">
          ...
          &quot;
          Sou estudante de desenvolvimento de software na Trybe, onde já concluí o módulo
          de front-end e estou cursando back-end (1 ano de curso intensivo). Também estou
          cursando Análise e Desenvolvimento de Sistemas na Uninter, no 1° ano de curso.
          <br />
          <br />
